  ...
  return (
    <section id="pricing" className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* <= iPad: horizontal snap scroll | >= lg: original 3-col grid exactly */}
        <div
          className="
