    ...
    <div className="relative w-full">
      ...
      >
        ...
        <div className="flex justify-around items-center p-4 bg-background rounded-2xl shadow-sm">
          ...
          <KeyStat
            icon={Flame}
            value={`${Math.round(adjustedNutrition.calories)}`}
            label="Calories"
          />
        </div>
          ...
          <Tabs defaultValue="ingredients">
            ...
            <TabsContent value="ingredients" className="pt-6">
              <h3 className="text-xl font-bold mb-4 text-center">
                Ingredients for {portions} serving{portions > 1 && "s"}
              </h3>
              <ul className="space-y-3">
                {adjustedIngredients.map((ing, index) => (
                  <li
                    key={index}
                    className="flex justify-between items-center text-base p-3 bg-background rounded-lg"
                  >
                  ...
                  <li key={index} className="flex items-start gap-3">
                    ...
                    <label
                      ...
                      className={cn(
                        ...
                        checkedSteps[index] && "line-through opacity-60"
                      )}
                    >
                      {step}
                    </label>
