...
export default function NutritionProgression({ data }: { data: ProgressData['nutrition'] }) {
    ...
    const intakeCalories = todayData.kcal;
    const exerciseCalories = Math.round(data.kcalBurnedLast7Days / 7); // Average daily burned
    const youCanEat = Math.max(data.recommended.kcal - intakeCalories + exerciseCalories, 0);
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                            ...
                            <Pie
                                ...
                                innerRadius={60}
                                startAngle={90}
                                endAngle={-270 + (360 * (calorieProgress / 100))}
                                isAnimationActive={false}
            ...
            <div className="space-y-4">
                ...
                <div>
                    <div className="flex justify-between items-center mb-1">
                        ...
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                            {todayData.fat}g / {data.recommended.fat}g
                        </p>
                    </div>
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div
