...
import { ScheduledTask, typeConfig, ContentItem } from "@/mockdata/programs/mockprograms";
import { PlayCircle } from "lucide-react";
import { useRef } from "react";

// A new, cleaner item component for the list
const TaskListItem = ({ item }: { item: ContentItem }) => {
  return (
...
export default function ProgramDetailView({
  ...
  const handleStartClick = () => {
    // Navigate to the detailed view when the button is clicked
  ...
  return (
    ...
    >
      {/* HEADER (No changes here, kept as is) */}
      ...
      {/* FOOTER (No changes here, kept as is) */}
