...
// Removed the unused onExploreMore prop
const CoachMainHeader = ({ onClick }: { onClick: () => void }) => {
    return (
        <Card
            // This entire card is now the entry point to view the coach bio
            ...
            onClick={onClick} // Make the whole card clickable again
        >
            ...
            <CardContent className="relative p-4 md:p-6 text-white flex items-center justify-between min-w-0">
                ...
                {/* ChevronRight is just an indicator for the drawer now */}
