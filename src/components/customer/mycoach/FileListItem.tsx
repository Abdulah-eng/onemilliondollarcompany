...
import { sharedFiles } from '@/mockdata/mycoach/coachData'; // Assuming coachData.ts defines the sharedFiles array

// Reusable component for a single file item (DRY helper)
...
// Reusable component for the entire file list wrapper
