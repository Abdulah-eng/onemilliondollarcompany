...
// A small component for the key stats like calories and time
...
export default function InteractiveRecipeView({ recipe }: { recipe: Recipe }) {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-0 left-0 right-0 h-40 bg-primary/10 dark:bg-primary/5 rounded-t-3xl" />
      ...
      {/* Main Content Card */}
      <div className="relative bg-card p-6 rounded-3xl -mt-28 space-y-6">
        
        {/* Portion Adjuster */}
        <div className="pt-28 flex justify-center">
             <div className="flex items-center gap-4 bg-background p-2 rounded-full">
        ...
        {/* Mobile & Tablet: Tabbed layout for Ingredients/Instructions */}
        <div>
