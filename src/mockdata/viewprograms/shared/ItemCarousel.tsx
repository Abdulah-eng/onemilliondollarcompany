...
// A generic interface for any item in the carousel
          ...
          return (
            <button
              ...
              className={cn(
                ...
                // Apply a ring for selection, which works well with circles
            ...
            >
              ...
              {item.isCompleted && (
                 <div className="absolute inset-0 bg-primary/70 rounded-full flex items-center justify-center">
                    <Check className="h-10 w-10 text-primary-foreground" />
                 </div>
              )}

              {/* Label Text */}
              <span className="absolute bottom-2 left-0 right-0 px-1 text-center text-xs font-semibold text-white truncate">
                {item.label}
              </span>
            </button>
          );
